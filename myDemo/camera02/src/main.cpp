...
const char *WIN_TITLE = "My Camera 02";
...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        ImGui::Text("position");
        ImGui::SliderFloat3("position", glm::value_ptr(solar_system.translation), -2.0, 2.0);

        ImGui::Text("rotation");
        ImGui::SliderFloat3("rotation", glm::value_ptr(solar_system.rotation), -5.0, 5.0);

        ImGui::Text("scale");
        ImGui::SliderFloat3("scale", glm::value_ptr(solar_system.scale), -10.0, 10.0);
